...
if mode == "From Location":
    ...
    st.session_state['pm25'] = st.number_input('PM2.5', 0.0, st.session_state['pm25'])
    st.session_state['pm10'] = st.number_input('PM10', 0.0, st.session_state['pm10'])
    st.session_state['co'] = st.number_input('CO', 0.0, st.session_state['co'])
    st.session_state['so2'] = st.number_input('SO2', 0.0, st.session_state['so2'])
    st.session_state['no2'] = st.number_input('NO2', 0.0, st.session_state['no2'])
    st.session_state['o3'] = st.number_input('O3', 0.0, st.session_state['o3'])
